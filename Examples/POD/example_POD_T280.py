...
## Dump to ParaView
# Spatial modes
d.add_variable('spatial_modes_U',d.info(VARIABLE)['point'],6,0,pyLOM.POD.extract_modes(PSI,1,d.npoints,modes=[1,4,6,2,5,3]))
d.add_variable('spatial_modes_V',d.info(VARIABLE)['point'],6,0,pyLOM.POD.extract_modes(PSI,2,d.npoints,modes=[1,4,6,2,5,3]))
d.add_variable('spatial_modes_W',d.info(VARIABLE)['point'],6,0,pyLOM.POD.extract_modes(PSI,3,d.npoints,modes=[1,4,6,2,5,3]))
