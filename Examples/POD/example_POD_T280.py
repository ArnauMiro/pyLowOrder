...
pyLOM.io.pv_writer(m,d.to_cpu(['spatial_modes_U','spatial_modes_V','spatial_modes_W']),'modes',basedir='out/modes',instants=[0],times=[0.],vars=['spatial_modes_U','spatial_modes_V','spatial_modes_W'],fmt='vtkh5')
...
pyLOM.POD.plotSnapshot(m,d.to_cpu(['VELOR']),vars=['VELOR'],instant=0,component=0,cmap='jet')
