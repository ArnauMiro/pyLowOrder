...
## Dump to ParaView
# Spatial modes
d.add_field('spatial_modes_U',3,pyLOM.POD.extract_modes(PSI,1,len(d),modes=[1,2,3]))
d.add_field('spatial_modes_V',3,pyLOM.POD.extract_modes(PSI,2,len(d),modes=[1,2,3]))
...
if pyLOM.utils.is_rank_or_serial(0):
	...
	pyLOM.POD.plotMode(V[:,:-1],t[:-1],modes=[1,2,3])
