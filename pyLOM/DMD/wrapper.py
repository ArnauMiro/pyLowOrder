...
from ..vmmath       import vector_norm, vecmat, matmul, temporal_mean, subtract_mean, tsqr_svd, transpose, eigen, diag#, polar, vandermonde, conj, cholesky, inv, flip
