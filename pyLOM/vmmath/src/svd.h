...
int srandomized_qr(float *Ui, float *B, float *Ai, const int m, const int n, const int r, const int q, unsigned int seed, MPI_Comm comm);
...
int drandomized_qr(double *Ui, double *B, double *Ai, const int m, const int n, const int r, const int q, unsigned int seed, MPI_Comm comm);
