...
cdef extern from "vector_matrix.h" nogil:
	...
	cdef void   c_svecmatT           "svecmatT"(float *v, float *A, const int m, const int n)
	...
	cdef void   c_dvecmatT           "dvecmatT"(double *v, double *A, const int m, const int n)
	...
	cdef void   c_cvecmatT           "cvecmatT"(np.complex64_t *v, np.complex64_t *A, const int m, const int n)
	...
	cdef void   c_zvecmatT           "zvecmatT"(np.complex128_t *v, np.complex128_t *A, const int m, const int n)
...
cdef extern from "averaging.h" nogil:
	...
	cdef void c_snorm_variance       "snorm_variance"(float *out, float *Xnomean, float *X_var, const int m, const int n)
	# Double precision
	...
	cdef void c_dnorm_variance       "dnorm_variance"(double *out, double *Xnomean, double *X_var, const int m, const int n)
cdef extern from "qr.h" nogil:
	# Single precision
