...
def QR(vardict:dict, nmodes:int, ptable:PartitionTable, iiload:int, iisave:int, restart:bool=False, basedir:str='.'):
	r"""
	Function to compute the randomized QR factorization on data which is being generated runtime.
	Once the of each variable is computed, it is saved in a .h5 file. Only 2 .h5 files are written,
	`*-1.h5` and `*-2.h5`, as they get overwritten every odd or even QR computation, respectively.
