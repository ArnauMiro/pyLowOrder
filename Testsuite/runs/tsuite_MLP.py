...
#pyLOM.pprint(0,f"TSUITE MAE = {np.abs(scaled_preds - np.array(scaled_y)).mean()}")
#pyLOM.pprint(0,f"TSUITE MRE = {np.abs(scaled_preds - np.array(scaled_y)).mean() / abs(np.array(scaled_y).mean() + 1e-6)}")
#pyLOM.pprint(0,f"TSUITE MSE = {((scaled_preds - np.array(scaled_y)) ** 2).mean()}")
