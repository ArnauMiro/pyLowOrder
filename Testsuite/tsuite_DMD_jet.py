...
## Dump to ParaView
# Spatial modes
d.add_variable('P_MODES_REAL',True,6,pyLOM.DMD.extract_modes(Phi,1,d.mesh.npoints,real=True,modes=[1,4,6,2,5,3]))
d.add_variable('P_MODES_IMAG',True,6,pyLOM.DMD.extract_modes(Phi,1,d.mesh.npoints,real=False,modes=[1,4,6,2,5,3]))
